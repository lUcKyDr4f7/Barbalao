import { getStdImg } from "./AllCategories.js";
...
class Product {
    constructor(id_prod, nome_prod, preco_prod, descricao_prod, categoria, imagens_prod=null) {
        this.id_prod = id_prod;
        this.nome = nome_prod;
        this.preco = preco_prod;
        this.descricao = descricao_prod;
        this.categoria = categoria;
        this.imagens = imagens_prod?imagens_prod:[getStdImg(categoria)];
    }
}

export function getProdFromId(id_prod) {
    return AllProducts.filter(p => p.id_prod == id_prod)[0];
}

export function getProdFromCateg(id_categ) {
...
export function formatPrice(preco) {
    return (preco && typeof preco == 'number') ? "R$" + preco.toFixed(2).replace('.', ',') : "Consultar preço.";
}

export const AllProducts = [
    new Product(1, 'X-Bacon', 32, 'Hambúrguer, queijo, bacon, alface e tomate', 7, ['/Banners/Pasteis.jpg', '/Banners/Lanches.jpg']),
    ...
    new Product(75, 'Palmito', 22.50, 'Pastel de palmito', 15),
    new Product(76, 'Da Casa', 23.50, 'Pastel de queijo, alho frito e orégano', 15),
    new Product(77, 'Hambúrguer com Queijo', 22.50, 'Pastel de hambúrguer com queijo', 15),
    ...
    new Product(84, 'Do Chefe', 24.50, 'Pastel de queijo com rúcula, tomate e alho frito', 16),
    new Product(85, 'Costela', 26, 'Pastel de costela', 16),
    new Product(86, 'Costela com Queijo', 27.50, 'Pastel de costela com queijo', 16),
    new Product(87, 'Costela com Catupiry', 27.50, 'Pastel de costela com catupiry', 16),
    ...
    new Product(97, 'Batata Frita do Cheff', 52.50, 'Meia porção de batata frita com queijo e alho frito', 32),
    new Product(98, 'Batata Frita Top', 62.65, 'Meia porção de batata frita com bacon, cheddar, catupiry, calabresa e alho frito', 32),
    new Product(99, 'Tábua de Frios', 52.15, 'Tábua de frios com provolone, salame, azeitona preta, presunto, muçarela e palmito', 32),
    new Product(100, 'Suprema dos Gaioleiros', 65.45, 'Grelhada ou à milanesa, alho, bacon e catupiry', 32),
]
