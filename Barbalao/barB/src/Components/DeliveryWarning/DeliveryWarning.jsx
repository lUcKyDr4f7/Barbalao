...
import { CircleX, MapPinned, Coins } from 'lucide-react';
    ...
    return(
        ...
        <Backdrop customClass={styles.backdrop} show={isClosing} close={() => closeModal()}>
            <div className={styles.deliveryWarning}>
                <h1 className={styles.dwTitle}>Delivery {/* <i className="ri-takeaway-fill"></i> */}</h1>
                <p className={styles.dwInfo}><MapPinned /> Entregamos somente para a cidade de Águas de Lindóia</p>
                <p className={styles.dwInfo}><Coins /> O valor da entrega é fixo de R$2,00</p>
