...
export default function CategP() {
  return (
      <>
        <h2 className='titleCateg'>Cardápio</h2>
        <Swiper className="brandsSwiper"slidesPerView={2.426} slidesPerGroup={2.426} centerInsufficientSlides={true} allowTouchMove={false} navigation={true} modules={[Navigation]} swipeable={true} slidesOffsetBefore={15} slidesOffsetAfter={395} onSlideChange={() => console.log('slide change')} onSwiper={(swiper) => console.log(swiper)}>
            <SwiperSlide className="swiper-slide avaliable start"><img src={Lanche}/><h2>Lanches</h2></SwiperSlide>
            <SwiperSlide className="swiper-slide avaliable"><img src={Pastel}/><h2>Pastéis</h2></SwiperSlide>
            <SwiperSlide className="swiper-slide avaliable"><img src={Salgado}/><h2>Salgados</h2></SwiperSlide>
            <SwiperSlide className="swiper-slide avaliable"><img src={Porção}/><h2>Porções</h2></SwiperSlide>
            <SwiperSlide className="swiper-slide avaliable"><img src={Bebida}/><h2>Bebidas</h2></SwiperSlide>
            <SwiperSlide className="swiper-slide avaliable end"><img className='bebidaA' src={BebidaA}/><h2 className='bebidA'>Bebidas Alcólicas</h2></SwiperSlide>
        </Swiper>
      </>
  );
}
